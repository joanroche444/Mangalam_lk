...
export default function AddIncomeForm() {
  ...
  return (
    ...
    >
      <h1 className="text-5xl font-bold text-white text-center mb-6 cursor-pointer transition-all duration-1000 ease-in-out font-serif italic">
        Add Your Income
      </h1>
      ...
      {isModalVisible && (
        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-1/3 text-center">
            ...
            <button
              onClick={closeModal}
              className="mt-6 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-400"
            >
              Close
            </button>
          </div>
